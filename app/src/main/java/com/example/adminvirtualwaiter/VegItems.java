...
public class VegItems extends AppCompatActivity {
...
ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_veg_items);
        addveg=findViewById(R.id.Addvegitem);
        name=findViewById(R.id.itemname);
        imageView=findViewById(R.id.vegimg);
        ...
        addveg.setOnClickListener(new View.OnClickListener() {
            ...
            {
                progress=new ProgressDialog(VegItems.this);
    ...
    private void storeInFirebase() {
     ...
     DatabaseReference databaseReference=firebaseDatabase.getReference("AdminVegItems");
               databaseReference.child(name.getText().toString()).setValue(singleItem).addOnCompleteListener(new OnCompleteListener<Void>() {
                   ...
                   public void onComplete(@NonNull Task<Void> task) {
                       if (task.isSuccessful())
                       {
                           ...
                           Toast.makeText(VegItems.this, "Unable to insert", Toast.LENGTH_SHORT).show();
                   }
               });
    }
