...
public class Starters extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addstarters=findViewById(R.id.Addstartersitem);
        name=findViewById(R.id.itemname);
        imageView=findViewById(R.id.starterimg);
        cost=findViewById(R.id.cost);
        firebaseDatabase=FirebaseDatabase.getInstance();
        addstarters.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                progress=new ProgressDialog(Starters.this);
    ...
    private void storeInFirebase() {
        ...
        DatabaseReference databaseReference=firebaseDatabase.getReference("Admin-StarterItems");
        databaseReference.child(name.getText().toString()).setValue(singleItem).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful())
                {
                    ...
                    Toast.makeText(Starters.this, "Unable to insert", Toast.LENGTH_SHORT).show();
            }
        });
    }
